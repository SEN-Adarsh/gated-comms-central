    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          <h2 className="text-xl font-bold mb-4">Community Directory</h2>
          <p className="text-gray-600 mb-4">Connect with your neighbors and community staff. View contact information for official community representatives and opted-in residents.</p>
          <div className="grid md:grid-cols-3 gap-4">
            <Card>
              ...
              <CardContent className="pt-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm">Sat: 10 AM - 2 PM</p>
                  <p className="text-sm">Phone: (555) 123-4567</p>
                  <p className="text-sm">Email: office@gatedcomms.com</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="pt-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm">Regular Requests:</p>
                  <p className="text-sm">Mon-Sat: 8 AM - 7 PM</p>
                  <p className="text-sm">Phone: (555) 123-4569</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="pt-4">
                <div className="space-y-1">
                  <p className="text-sm font-medium">Gate Security:</p>
                  <p className="text-sm">24/7 Coverage</p>
                  <p className="text-sm">Security Office:</p>
                  <p className="text-sm">Located at Main Entrance</p>
                  <p className="text-sm">Phone: (555) 123-4570</p>
                </div>
              </CardContent>
            </Card>
          </div>
          <div className="mt-6 text-center">
            <Button variant="outline">View Complete Directory</Button>
          </div>
        </div>
      </main>
